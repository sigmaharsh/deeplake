...
class DeepLakeDataLoader(DataLoader):
    ...
    def __iter__(self):
        if self._dataloader is None:
            ...
            htype_dict, ndim_dict, tensor_info_dict = get_htype_ndim_tensor_info_dicts(dataset, data_tensors, tensor_info_tensors)
            ...
            if deeplake.constants.RETURN_DUMMY_DATA_FOR_DATALOADER:
                ...
                libdl_dataset = dataset_to_libdeeplake(dataset)
