...
def test_attribute_based_filtering():
    ...
    view_dict = filter_utils.attribute_based_filtering_python(ds, filter=filter_dict, progressbar=False)

    view_udf = filter_utils.attribute_based_filtering_python(ds, filter=filter_udf, progressbar=False)
